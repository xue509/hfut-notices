...
class NoticeClassifier:
    ...
    RESEARCH_RULES = [
        ...
        # 归到半年这批通知后补的锚点：省厅/部委的项目征集，标题里不写
        # 「基金委」但同样是科研申报。注意别用「组织实施」这种宽词。
        (["组织申报", "人员申报", "预指南", "课题指南", "项目建议书",
          "基金申报", "产学研", "科技厅", "留学基金", "专项计划",
          "培育工程", "科研项目", "科技计划"], "项目申报"),
    ]
    ...
    ACADEMIC_RULES = [
        ...
        # 推免的正式标题很少写「推免」两个字，全称是「推荐优秀应届本科
        # 毕业生免试攻读研究生」；交换项目、学位申请、教材审核同理
        (["免试攻读", "推荐优秀应届", "人才培养方案", "培养计划", "专业设置",
          "学位授予", "学位申请", "导师资格", "微专业", "期末考试",
          "教材", "交换项目", "交换生", "二级学科", "交叉学科",
          "教学检查", "实习教学"], "教学运行"),
    ]
    ...
    SUPPORT_RULES = [
        ...
        # ⚠️「实施工作」里含「施工」两个字，裸写「施工」会把科普活动通知
        # 也吞进后勤，所以一律用「封闭施工 / 施工期间」这种带上下文的锚点
        (["停气", "抢修", "封闭施工", "施工期间", "临时封闭", "临时绕行",
          "校园网", "VPN", "实验室安全", "安全隐患", "消防",
          "体检", "废物", "化学试剂", "电梯", "门禁", "一卡通"], "校园物业"),
    ]
...
if __name__ == "__main__":
    ...
    tests = [
        ...
        ("关于做好2026年暑期实验室安全管理工作的通知", "support", "校园物业"),
        ("关于开通2026年暑期学生心理关爱服务线上平台的通知", "student", ""),
        # 「实施工作」里藏着「施工」，这条就是拿来钉住这个坑的
        ("全民科学素质纲要实施工作办公室关于广泛开展2026年全国科普月活动的通知", "other", ""),
        ("关于屯溪路校区聚英路施工期间道路临时绕行的通知", "support", ""),
        ("关于防范台风的温馨提示", "support", ""),
        ...
        ("省科技厅组织申报2026年安徽省科技创新攻坚计划项目", "research", "项目申报"),
        ("关于组织申报2026年中国高校产学研创新基金－联合专项（八期）的通知", "research", ""),
        ("关于启动2026年创新型人才国际合作培养项目第三批人员申报工作的通知", "research", ""),
        # ===== 教务教学 =====
        ("关于合肥校区2026年下半年全国大学英语四、六级考试报名的通知", "academic", ""),
        ("关于做好2026-2027学年第一学期实验教学安排的通知", "academic", ""),
        ("关于做好2024年转专业学生管理工作的通知", "academic", ""),
        # 推免的正式标题不写「推免」二字，写成全称 —— 别漏了
        ("合肥工业大学关于2027年推荐优秀应届本科毕业生免试攻读研究生工作的通知", "academic", ""),
        ("2026-2027年铭传大学秋季学期交换项目招生通知", "academic", ""),
        ("关于开展2026-2027学年第一学期本科教材选用审核工作的通知", "academic", ""),
        ("合肥工业大学2026年微专业招生通知", "academic", ""),
        # ===== 学工通知 =====
        ...
        ("关于合肥校区2026级本科生新生入学体检工作的通知", "student", "新生入学"),
        # 「毕业生」在毕业服务那条规则里，跳蚤市场也算毕业季活动，不抢到日常教育
        ("合肥校区2026届毕业生跳蚤市场活动通知", "student", "毕业服务"),
        ("关于2026年“满天星”朋辈心理骨干成员招募的通知", "student", "心理健康"),
        # ===== 后勤服务 =====
        ...
        ("停气通知", "support", "校园物业"),
        ("关于校园网客户端VPN升级及旧版停用的通知", "support", "校园物业"),
        ("关于启用实验室废物上门回收服务的通知", "support", "校园物业"),
